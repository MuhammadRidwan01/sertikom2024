            ...
            <div class="flex items-center space-x-4">
                ...
                >
                    <svg x-show="!darkMode" class="w-6 h-6 text-gray-800" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m3.343-3.657l-.707-.707m12.728 12.728l-.707.707M12 8a4 4 0 100 8 4 4 0 000-8z"></path>
                    </svg>
                ...
                @auth
                    <a href="{{ url('/dashboard') }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
                        Dashboard
                    </a>
                @else
                    <div class="space-x-2">
                        <a href="{{ route('login') }}" class="px-4 py-2 bg-gray-200 dark:bg-gray-700 rounded-lg">Login</a>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
                    <div class="md:flex">
                        ...
                        <div class="p-8">
                            ...
                            <h2 class="block mt-1 text-3xl leading-tight font-bold text-gray-900 dark:text-white">XPro Library</h2>
                            <p class="mt-2 text-gray-600 dark:text-gray-300">
                                XPro Library is a digital library management system developed for the Laravel Competency Certification (Sertikom).
                                Built with modern technology using Laravel, Livewire, and Alpine.js, this website offers a responsive and
                                interactive user experience. Our key features include an intuitive library data visualization system.
                            </p>
                            <div class="mt-4">
                                <span class="inline-block bg-gray-200 dark:bg-gray-700 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 dark:text-gray-300 mr-2">#Laravel</span>
                                <span class="inline-block bg-gray-200 dark:bg-gray-700 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 dark:text-gray-300 mr-2">#Livewire</span>
                                <span class="inline-block bg-gray-200 dark:bg-gray-700 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 dark:text-gray-300">#AlpineJS</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
                <div class="flex border-b dark:border-gray-700 mb-8">
                    <button
                        ...
                        :class="activeTab === 'features' ? 'border-blue-600 text-blue-600' : 'border-transparent text-gray-500'"
                    ...
                    <button
                        ...
                        :class="activeTab === 'categories' ? 'border-blue-600 text-blue-600' : 'border-transparent text-gray-500'"
                        class="px-4 py-2 border-b-2 font-semibold transition-colors"
                    >
                        Book Categories
                    </button>
                    <button
                        ...
                        :class="activeTab === 'books' ? 'border-blue-600 text-blue-600' : 'border-transparent text-gray-500'"
                        class="px-4 py-2 border-b-2 font-semibold transition-colors"
                    >
                        Latest Books
                    </button>
...
<svg class="w-12 h-12 text-blue-600 mb-4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="128px" height="133px" viewBox="0 0 128 128" version="1.1">
<g id="surface1">
...
<p class="text-gray-600 dark:text-gray-300">
    Alpine.js provides a simple and lightweight development experience for building dynamic user interfaces. With an intuitive syntax, it offers the flexibility of larger frameworks without the additional overhead, making it an excellent choice for modern projects requiring interactivity and minimal complexity.
                ...
                <div x-show="activeTab === 'categories'" class="grid md:grid-cols-3 gap-4">
                    <template x-for="category in categories">
                        <div class="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
                            ...
                            <span x-text="category.books_count + ' books'" class="text-gray-500 dark:text-gray-400 ml-2"></span>
                        </div>
                    </template>
                </div>
                ...
                <div x-show="activeTab === 'books'" class="grid md:grid-cols-3 gap-4">
                    <template x-for="book in books">
                        <div class="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
                            ...
                            <span x-text="book.tahun_terbit" class="text-sm text-gray-500 dark:text-gray-400"></span>
                        </div>
                    </template>
                </div>
            </div>
            ...
            <div class="mt-12 bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
                ...
                <div class="flex items-center space-x-4">
                    <img src="https://ridwan-porto.my.id/image/MUHAMMAD%20RIDWAN%20(2).webp" alt="Muhammad Ridwan" class="w-16 h-16 rounded-full">
                    <div>
                        ...
                        <a href="https://ridwan-porto.my.id/" target="_blank" class="text-blue-600 hover:underline">Portfolio Website</a>
                    </div>
                </div>
